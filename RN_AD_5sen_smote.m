...
%Se realiza el aumento de datos (usando SMOTE)
...
for AD=[0 100 500 2000]
    ...
    V1de_a = aumento_datos_smote(V1de,kk,np,na);
    V2de_a = aumento_datos_smote(V2de,kk,np,na);
    V3de_a = aumento_datos_smote(V3de,kk,np,na);
    V4de_a = aumento_datos_smote(V4de,kk,np,na);
    V5de_a = aumento_datos_smote(V5de,kk,np,na);
    V6de_a = aumento_datos_smote(V6de,kk,np,na);
